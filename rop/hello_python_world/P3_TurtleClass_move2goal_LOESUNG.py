...
# Version vom 21.10.2019 by OJ
#
# Loesung aus dem Turtlesim Tutorial
...
class TurtleBotClass:
	...
	def move2goal(self):
		...
		rospy.loginfo("Goal is       %s %s", goal_pose.x, goal_pose.y)
		rospy.loginfo("Distannce to Goal is  %f ", self.euclidean_distance(goal_pose))
		rospy.loginfo("SteeringAngle to Goal is  %f ", self.steering_angle(goal_pose))
